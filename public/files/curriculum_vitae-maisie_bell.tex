 ...
 \begin{itemize}
	...
	\begin{itemize*}
	    \item Site Reliability Engineer for the Object Storage team
            ...
            \item On call for a highly critical service with millions of customers, requiring extremely high availability
            \item Working with a mix of bare metal and a wide variety of orchestration platforms
	    \item Built a part of a bespoke control plane for running services on bare metal, that managed release safety and integrated with other key partner services
	    \item Worked on improving the machine provisioning pipeline, automating configuration to reduce manual steps required to run our service
 	\end{itemize*}
